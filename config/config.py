...
parser.add_argument('--sn_annotation', type=str, default=r'./data/mimic_cxr/annotation.json', help="annotation file of the dataset")
parser.add_argument('--sw_annotation', type=str, default=r'./data/mimic_cxr/annotation.json', help="annotation file of the dataset")
...
parser.add_argument('--data_ratio', default=1, type=float, help="0~1. ratio of dataset to use")
# ========================= Model Settings ============================
parser.add_argument("--img_encoder", type=str, default="swim")
#parser.add_argument("--emb_dim", type=int,default=4096, help="")
parser.add_argument('--swintransformer_road', default='', type=str, help="vision model to use")
parser.add_argument('--llama_model', default='./hf/Llama-2-7b-chat-hf', type=str, help="LLM model to use")
parser.add_argument('--vicuna_model', default='./hf/vicuna-7b-v1.5', type=str, help="LLM model to use")
parser.add_argument('--rad_dino_path', default='./hf/rad-dino', type=str, help="rad_dino_path")
parser.add_argument('--cxr_bert_path', default='./hf/BiomedVLP-CXR-BERT-specialized', type=str, help="cxr_bert_path")
parser.add_argument('--chexbert_path', default='./hf/chexbert.pth', type=str, help="chexbert_path")
parser.add_argument('--bert_path', default='./hf/bert-base-uncased', type=str, help="bert_path")
...
parser.add_argument('--vision_token_number', default=64, type=int)
parser.add_argument('--loss_mode', default='sentence', type=str)
parser.add_argument('--test_mode', default='train', type=str)
...
parser.add_argument('--visual_delta_file', type=str, default=None, help='the delta file to load')
